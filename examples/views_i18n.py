...
class Index(MenuBoardView):
    ...
    def get(self, **kwargs):
        ...
        if session.get('simpleboard', False):
            return tpl('i18n/simpleboard.min.j2', **params)
        else:
            return tpl('i18n/mainboard.min.j2', **params)
...
class Home(MenuBoardView):
    ...
    def get(self, **kwargs):
        html = tpl('i18n/option_panel.min.j2', message=gettext("Welcome"))
...
class InputForm(MenuBoardView):
    ...
    def get(self, **kwargs):
        ...
        html = tpl('i18n/input_form.min.j2', contents=UiInputForm(options))
...
class Datagrid(MenuBoardView):
    ...
    def get(self, **kwargs):
        ...
        html = tpl('i18n/data_grid.min.j2', contents=UiStdDataGrid(options))
...
class QueryBuilder(MenuBoardView):
    ...
    def get(self, **kwargs):
        ...
        html = tpl('i18n/query_builder.min.j2', contents=UiQBuilder(options))
...
class Loader(MenuBoardView):
    ...
    def get(self, **kwargs):
        ...
        html = UiAlert('message', gettext('loaded after delay'),
                       styles='p-3', dismiss=False)
        html += tpl('i18n/progress_loader.min.j2')
...
class Loginpage(MenuBoardView):
    ...
    def get(self, **kwargs):
        ...
        if action == 'load':
            ...
            return tpl('i18n/loginpage.min.j2', **params)
